...
# from flask import Fyyyyyylask, request, jsonify
# from pymongo import MongoClient
# import pandas as pd
# import os
# import uuid
...
#     # Optionally, handle video creation and update MongoDB if needed
#     # video_link = create_and_save_animation(new_content, book_name, grade_name, chapter_name, heading_name, topic_name)
#     # if video_link:
#     #     topics_col.update_one(
#     #         {'_id': topic_id},
...
#                         content = details.get('content', '')
#                         quiz = details.get('quiz', '')
#                         video_link = details.get('video_link', '')  # Optional, depending on if you handle video
#                         store_to_mongodb(book, grade, chapter, heading, topic, content, quiz, video_link)
