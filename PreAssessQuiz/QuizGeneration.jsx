...
const QuizGeneration = () => {
  ...
  return (
    <div className=' d-flex flex-col align-items-center justify-content-center text-dark'>
                  ...
                  ['radio'].map((type) => (
                    <div key={`inline-${type}`} className="mb-3 flex flex-col ">
                      <Form.Check
                        ...
                        checked={SelectedAnswer.current[index] === Question.options[0]}
                      />
                      <Form.Check
                        inline
                        ...
                        className='my-3'
                        onChange={(event) => handleChange(index, event.target.value)}
                        checked={SelectedAnswer.current[index] === Question.options[1]}
                      />
                      <Form.Check
                        inline
                        ...
                        className='my-3'
                        onChange={(event) => handleChange(index, event.target.value)}
                        checked={SelectedAnswer.current[index] === Question.options[2]}
                      />
                      <Form.Check
                        inline
                        ...
                        className='my-3'
                        onChange={(event) => handleChange(index, event.target.value)}
                        checked={SelectedAnswer.current[index] === Question.options[3]}
                      />
                    </div>
                  ))
                } */}
      ...
      <button className=' btn btn-success m-1 shadow-md btn-md' onClick={()=>alert("you can not reverse ","hehe")}>Submit</button>
      </div> */}
      {/* <MarkQuizAnswer /> */}
    </div>
  )
